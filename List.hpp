...
public:
    ...
    // Description: Returns the MAX_ELEMENTS to check if the list is full before adding a new element
    static int getMAX_ELEMENTS();
    ...
    //Description: overloaded "<<" operator for printing purposes
